...
• Criar uma função de **multiplicação** que receba dois números e retorne o resultado.  
• Criar uma função de **saudação** que receba um nome e retorne uma mensagem personalizada.  
• Utilizar a tipagem do TypeScript corretamente.  
